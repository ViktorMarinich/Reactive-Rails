...
export default class NewsItem extends React.Component{
  ...
  render() {
    ...
    const video = (typeof this.isYoutubeLink(this.props.text) == 'boolean')? '' :  <iframe id={this.props.id} src={`https://www.youtube.com/embed/${this.isYoutubeLink(this.props.text)}?autoplay=0`} width="292" height="230" frameBorder="0"  allowFullScreen type="text/html" ></iframe>
    return (
    <div key={this.props.id} style={{borderStyle: 'solid', backgroundColor: 'white',borderWidth: '1px', marginTop: '5px', padding: '3px'}}>
      ...
      <div style={{display: 'flex', minWidth: '300px', flexDirection: 'column', alignItems:'flex-start', justifyContent: 'flex-start'}}>
